...
const ImageSearchDesktopPopup = (props) => {
  ...
  function finalizeImage() {
    ...
    const base64Data = croppedImageData.getCroppedCanvas().toDataURL()
    img.src = base64Data
    localStorage.setItem('imageSearched', base64Data)
  ...
  return (
    <div>
      <div className={styles.askADoubtPopupTopbanner}>
        ...
        <div>
          {imageUploaded == false && (
            <div className={styles.askADoubtPopupTopbannerTitle}>
              Upload an image
            </div>
          )}
          {!fileUploadError &&
            ...
            imageFinalized == false && (
              <div className={styles.askADoubtPopupTopbannerTitle}>
                Crop only one question<br></br>in the frame
              </div>
            )}
          {!fileUploadError &&
            imageUploaded == true &&
            imageFinalized == true && (
              <div className={styles.askADoubtPopupTopbannerTitle}>
                {' '}
                Scanning for matches in our question bank
              </div>
            )}
        </div>
        <div></div>
      ...
      <div className={styles.cameraImageCropper}>
        {imageUploaded == false && (
          <div>
            <div className={styles.fileBody}>
              ...
              <div className={styles.circleHolder}>
                <div className={styles.circle}>
                  <img
                    src={
                      'https://search-static-stg.byjusweb.com/assets/UploadIcon.png'
                    }
                    width='29'
                    height='29'
                    alt='UploadIcon'
            ...
            {fileUploadError && (
              <div className={styles.uploadFileError}>
                Inavlid file type ( only image files are accepted )
              </div>
            )}
          </div>
        )}
          ...
          <div>
            ...
            >
              ...
              <div className={styles.bottomSectionDesktop}>
                <div className={styles.pointer} onClick={handleRotateLeft}>
                  <img
                    src={
                      'https://search-static-stg.byjusweb.com/assets/rotateleft.png'
                    }
                    alt='loader'
                    height='40'
                    width='40'
                ...
                <div className={styles.pointer} onClick={handleRotate}>
                  <img
                    src={
                      'https://search-static-stg.byjusweb.com/assets/rotateright.png'
                    }
                    alt='loader'
                    height='40'
                    width='40'
